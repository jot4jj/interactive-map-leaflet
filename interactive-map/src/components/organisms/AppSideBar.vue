<template>
  <div class="fixed flex flex-col top-0 left-0 justify-evenly w-[25vw] h-full z-20">
...
defineEmits(['getUserLocation', 'resetView', 'clearMarkers', 'redirect', 'remove', 'setTheme']);
</script>